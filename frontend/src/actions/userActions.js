...
export const deleteUser = (id) => async(dispatch,getState) => {
    try{
        ...
        const{ userLogin:{userInfo} } = getState() //user should be Admin to delete the user using the path /api/users/delete/<str:pk>/ so we are fetching token of loggedIn admin user and sending it in headers
